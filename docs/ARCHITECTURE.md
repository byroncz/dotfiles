...
| Retorno OAuth de MCP por puerto publicado | Claude Code escucha solo en 127.0.0.1 dentro del contenedor | `socat` reenvía 0.0.0.0:54546 a 127.0.0.1:54545; Compose publica 127.0.0.1:54545 del Mac al 54546 |
